...
This request will fail if the `CIVITAI_API_KEY` environment variable is not set (or if it is invalid), or if the model type is unsupported, or if the system has less than 10% storage space free.
